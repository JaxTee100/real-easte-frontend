        ...
        >
          ...
          >
            ...
            <Select
              ...
              onValueChange={(value) => setFormState((prev) => ({ ...prev, estatetype: value }))}
            >
          ...
          >
            ...
            <Select
              ...
              onValueChange={(value) => setFormState((prev) => ({ ...prev, bathroomType: value }))}
            >
              <SelectTrigger className="mt-1 bg-black border-gray-600 text-white">
          ...
          <motion.div variants={fadeInUp} custom={12} className="col-span-full">
            ...
            >
              {isEditMode ? "Update Product" : isLoading ? "Adding House...." : "Add Product"}
            </Button>
          </motion.div>
        </motion.form>
      </motion.div>
